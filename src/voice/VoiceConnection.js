...
* @prop {String} id The ID of the voice connection (club ID)
...
class VoiceConnection extends EventEmitter {
    ...
    */
    ...
    /**
    * Switch the voice channel the bot is in. The channel to switch to must be in the same club as the current voice channel
    ...
    updateVoiceState(selfMute, selfDeaf) {
        if(this.shard.sendWS) {
            this.shard.sendWS(GatewayOPCodes.VOICE_STATE_UPDATE, {
                club_id: this.id === "call" ? null : this.id,
