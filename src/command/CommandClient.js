...
class CommandClient extends Client {
    ...
    * @arg {String} [commandOptions.description="An Eris-based Helselia bot"] The description to show in the default help command
    ...
    */
    constructor(token, options, commandOptions) {
        ...
        this.commandOptions = Object.assign({
            ...
            description: "An Eris-based Helselia bot",
            ignoreBots: true,
            ignoreSelf: true,
            name: null,
